...
<button id="rocketTopBtn" title="到最底部" style="margin-left:auto;background:rgba(255,255,255,0.05);border:1px solid #334155;border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:20px;line-height:1;flex-shrink:0;transition:all 0.2s">🚀</button>
</div>
</div>
...
<div class="sub" id="subRow" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;width:100%;max-width:1200px;box-sizing:border-box;margin-top:10px">更新: __UPDATE_TIME__ 香港時間 | 共<span id="count">__COUNT__</span>隻 自加<span id="customCount">0</span>隻 限流<span id="limitCount">0</span>隻 置頂<span id="pinCount">0</span>隻 |
