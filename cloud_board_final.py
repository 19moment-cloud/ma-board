...
/* V62 置頂觀察取消橙色邊框 */
#pinnedGrid .card, .pinned-section .card {border:none !important; box-shadow:none !important}
#pinnedGrid .card.橙, #pinnedGrid .card.綠, #pinnedGrid .card.藍, #pinnedGrid .card.紅, #pinnedGrid .card.灰, #pinnedGrid .card.白 {border:none !important}
...
<div id="lock">
<div style="position:absolute;left:12px;top:12px;background:#78350f;color:#fde68a;border:1px solid #92400e;padding:3px 10px;border-radius:8px;font-size:11px;font-weight:800">V62</div>
<h2>🔒 私有看板</h2>
...
<button id="rocketTopBtn" title="到最底部" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;font-size:24px;line-height:1;padding:6px 10px;border-radius:50%;z-index:10">🚀</button>
</div>
</div>
...
document.addEventListener('DOMContentLoaded', function(){
  function updateCounts(){
    ...
    var limit = document.querySelectorAll('.card.白, #grid-waiting .card').length;
