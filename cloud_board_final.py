...
for code,name in WATCHLIST:
    try:
        ...
        # V53 關鍵：時K MA包含盤前盤後 prepost=True，不再between_time過濾，盤後停在20:00最後一根去算MA20/60/240
        ...
        # V53 修漲跌幅：美股盤中日K可能還沒出今天，prev_close不能固定-2
        try:
            ...
            if last_day_date == last_60m_date:
                # 日K已包含今天，昨天是-2
