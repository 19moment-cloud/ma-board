...
<div id="lock">
<div style="position:absolute;left:12px;top:12px;background:#78350f;color:#facc15;border:1px solid #92400e;padding:3px 10px;border-radius:8px;font-size:11px;font-weight:800;box-shadow:0 0 8px rgba(250,204,21,0.3)">V65</div>
<h2>🔒 私有看板</h2>
...
<div class="header" id="headerRow" style="display:flex;align-items:center;width:100%;max-width:1200px;gap:12px;flex-wrap:nowrap;box-sizing:border-box;position:relative">
<h1 style="display:flex;align-items:center;gap:8px;flex-wrap:nowrap;flex-shrink:0"><a href="https://hk.finance.yahoo.com/markets" target="_blank" style="text-decoration:none;display:inline-flex;align-items:center" title="Yahoo HK"><img src="data:image/png;base64," style="margin-right:6px;width:32px;height:32px;border-radius:50%;object-fit:cover;display:inline-block;vertical-align:middle;filter:drop-shadow(0 0 2px rgba(255,255,255,0.3))" alt="moon" /></a> MA(20/60/240) 私有版 <span style="background:#78350f;color:#facc15;border:1px solid #92400e;padding:2px 8px;border-radius:8px;font-size:11px;font-weight:800;margin-left:8px;box-shadow:0 0 6px rgba(250,204,21,0.4)">V68</span></h1>
<div class="search" id="searchBox" style="margin-left:auto;flex:1;max-width:520px;min-width:200px;position:relative"><span class="icon">🔍</span><input id="search" type="text" placeholder="搜索代號/名稱" /></div>
<button id="rocketTopBtn" title="到最底部" style="background:rgba(255,255,255,0.08);border:1px solid #334155;border-radius:50%;width:38px;height:38px;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:22px;line-height:1;flex-shrink:0;transition:all 0.2s;margin-left:12px">🚀</button>
</div>
</div>

<div class="addRow" id="addRow" style="width:100%;max-width:1200px;box-sizing:border-box;display:flex;gap:10px;align-items:center;justify-content:flex-start"><input id="addInput" type="text" placeholder="加股：輸入自動出現選單" autocomplete="off" style="flex:1;min-width:200px"/><div id="yahooSuggest"></div><button class="addbtn" id="addBtn">+ 加股</button><button class="addbtn" id="clearBtn" style="background:#1e293b;color:#fff;border:1px solid #334155">清空自加</button></div><button class="addbtn" id="addBtn">+ 加股</button><button class="addbtn" id="clearBtn" style="background:#1e293b;color:#fff;border:1px solid #334155">清空自加</button></div>

<div class="sub" id="subRow" style="display:flex;align-items:center;gap:8px;width:100%;max-width:1200px;box-sizing:border-box;margin-top:10px;justify-content:flex-start"><span id="subText" style="flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">更新: __UPDATE_TIME__ 香港時間 | 共<span id="count" style="display:inline">__COUNT__</span>隻 自加<span id="customCount" style="display:inline">0</span>隻 限流<span id="limitCount" style="display:inline">0</span>隻 置頂<span id="pinCount" style="display:inline">0</span>隻 |</span>
<button id="filterUpBtn" style="padding:4px 12px;border-radius:8px;font-size:12px;font-weight:900;border:none;cursor:pointer;background:#16a34a;color:#fff;flex-shrink:0">漲0隻</button>
<button id="filterDownBtn" style="padding:4px 12px;border-radius:8px;font-size:12px;font-weight:900;border:none;cursor:pointer;background:#dc2626;color:#fff;flex-shrink:0">跌0隻</button>
<button id="filterAllBtn" style="padding:4px 12px;border-radius:8px;font-size:12px;font-weight:900;border:none;cursor:pointer;background:linear-gradient(135deg,#c084fc,#f472b6);color:#fff;flex-shrink:0">全部</button>
</div>
...
// V61 漲/跌篩選 排除置頂、共不含限流，新增限流計數
document.addEventListener('DOMContentLoaded', function(){
  function updateCounts(){
    var up=0, down=0;
    var grids = ['grid','grid-hk','grid-index'];
    var cards = [];
    grids.forEach(function(gid){
      var g = document.getElementById(gid);
      if(g) g.querySelectorAll('.card').forEach(function(c){ cards.push(c); });
    });
    cards.forEach(function(c){
      var pctEl = c.querySelector('.pct');
      if(!pctEl || pctEl.textContent.includes('限流')) return;
      if(c.classList.contains('白')) return;
    ...
    var total = cards.filter(function(c){ return !c.classList.contains('白'); }).length;
    // 限流不包含自加：白卡且不是自加（customStocks）才算限流
    var customTickers = [];
    try{ customTickers = (customStocks||[]).map(function(s){return s.code;}); }catch(e){}
    function isCustomCard(card){
      var t = card.getAttribute('data-ticker');
      if(!t) return false;
      if(card.classList.contains('custom')) return true;
      return customTickers.indexOf(t) >= 0;
    }
    var allWhite = document.querySelectorAll('.card.白');
    var limit = 0;
    allWhite.forEach(function(c){
      if(isCustomCard(c)) return; // 自加不算限流
      var txt = c.innerText || '';
      if(txt.includes('限流') || c.classList.contains('白')) limit++;
    });
    // 等候區的自加等候區不算，上面已排除
    var countEl = document.getElementById('count');
    if(countEl) countEl.textContent = total;
    var limitEl = document.getElementById('limitCount');
  ...
  function filterCards(type){
    ...
    grids.forEach(function(gid){
      ...
      g.querySelectorAll('.card').forEach(function(c){
        ...
        if(c.classList.contains('白')){ c.style.display = (type==='all' ? '' : 'none'); return; }
...
// V61 雙擊卡片只開一個進階圖表
const CHART_HASH_TEMPLATE = "#";
let chartOpened = false;
function openAdvancedChart(ticker){
  if(chartOpened) return;
  chartOpened = true;
  setTimeout(()=>{chartOpened=false;}, 1200);
  var t = ticker || 'QQQ';
  var h = CHART_HASH_TEMPLATE.replace(/QQQ/g, t);
  window.open('https://hk.finance.yahoo.com/chart/' + encodeURIComponent(t) + h, '_blank');
}
function bindChartDbl(){
  document.querySelectorAll('.card').forEach(function(card){
    if(card._dblBound) return; card._dblBound=true;
    card.addEventListener('dblclick', function(ev){
      ev.preventDefault(); ev.stopPropagation();
      var ticker = card.getAttribute('data-ticker');
      if(ticker) openAdvancedChart(ticker);
    });
  });
}
document.addEventListener('DOMContentLoaded', bindChartDbl);
setTimeout(bindChartDbl, 1200);
