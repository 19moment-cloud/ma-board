...
<div id="lock">
<div style="position:absolute;left:12px;top:12px;background:#78350f;color:#fde68a;border:1px solid #92400e;padding:3px 10px;border-radius:8px;font-size:11px;font-weight:800">V63</div>
<h2>🔒 私有看板</h2>
...
<button id="rocketTopBtn" title="到最底部" style="position:fixed;right:12px;top:12px;background:rgba(0,0,0,0.6);border:1px solid #334155;border-radius:50%;width:40px;height:40px;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:22px;line-height:1;z-index:1000;backdrop-filter:blur(4px)">🚀</button>
</div>
</div>
...
document.addEventListener('DOMContentLoaded', function(){
  function updateCounts(){
    ...
    // 限流不包含自加：只統計主板白卡，不含等待區
    var limit = document.querySelectorAll('#grid .card.白, #grid-hk .card.白, #grid-index .card.白').length;
